...
public enum DefaultSkins {
	...
	HEROBRINE(18, "Herobrine", new ResourceLocation("eagler/skins/19.herobrine.png"), SkinModel.STEVE),
	...
	ZOMBIE(21, "Zombie", new ResourceLocation("eagler/skins/22.zombie.png"), SkinModel.STEVE),
