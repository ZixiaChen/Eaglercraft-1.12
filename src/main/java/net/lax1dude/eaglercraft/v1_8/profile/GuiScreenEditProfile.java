...
public class GuiScreenEditProfile extends GuiScreen {
	...
	public void drawScreen(int mx, int my, float partialTicks) {
		...
		if(newSkinWaitSteveOrAlex && selectedSlot < numberOfCustomSkins) {
			...
			if(mouseOver) {
				drawCenteredString(this.fontRenderer, "Steve", skinX + skinWidth / 2, skinY + skinHeight + 6, cc);
			}
			...
			if(mouseOver) {
				drawCenteredString(this.fontRenderer, "Alex", skinX + skinWidth / 2, skinY + skinHeight + 8, cc);
			}
