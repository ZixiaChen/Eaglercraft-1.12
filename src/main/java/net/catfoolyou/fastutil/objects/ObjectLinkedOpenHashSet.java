...
public class ObjectLinkedOpenHashSet<K> extends AbstractObjectSortedSet<K> implements Serializable, Cloneable, Hash {
   ...
   private class SetIterator extends AbstractObjectListIterator<K> {
      ...
      SetIterator(K from) {
         ...
         } else if (ObjectLinkedOpenHashSet.this.key[ObjectLinkedOpenHashSet.this.last] == null
            ? from != null
            : !ObjectLinkedOpenHashSet.this.key[ObjectLinkedOpenHashSet.this.last].equals(from)) {
